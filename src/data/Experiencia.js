export const ExperienciaData = [
    {
        ...
        responsabilidades: [
            ...
            { descripcion: "Presentación de Portafolio de productos y servicios de la compañía, elaborando proyectos, propuestas y licitaciones, integración de soluciones con otros Partner de negocios" },
            { descripcion: "Posicionamiento y estructuración de proyectos de Transformación Digital para grandes entidades del estado" }
        ],
        logros: [
            { descripcion: "Apertura de cuentas con oportunidades importantes como DIAN – Proyecto Nuevo Sistema Aduanero" },
            { descripcion: "FISCALIA: Outsourcing Integral FISCATEL" }
        ]
    },
    {
        ...
        logros: [
            { descripcion: "Diseñé y estructuré la Agencia Comercial con el objetivo de tener una participación de mercado para la nueva solución de Factura Electrónica y ofrecer al mercado en general nuestro portafolio" },
            { descripcion: "Estructuré estrategias para presentación de portafolio de la compañía ante las empresas del Sector Privado, logrando realizar alianzas con Casas de Software para integrar nuestra solución y ofrecerlo a su portafolio de clientes" }
        ]
    },
    {
        ...
        logros: [
            { descripcion: "Posicionamiento y logro de negocios importantes para la empresa en nuevos clientes" },
            { descripcion: "Definición de una estrategia comercial para el posicionamiento de oportunidades de Factura Electrónica" }
        ]
    },
    {
        ...
        logros: [
            { descripcion: "Diseñé y estructuré la unidad de gobierno en la compañía con el objetivo de abrir nuevas oportunidades de negocio en el sector gobierno" },
            { descripcion: "Posicionamiento y cierre de negocios importantes en el sector, que fueron relevantes para la empresa" }
        ]
    },
    {
        ...
        logros: [
            { descripcion: "Posicionamiento de la empresa en el Sector Gobierno y cierre de licitaciones y proyectos importantes para la empresa" }
        ]
    },
    {
        empresa: "VERYTEL S.A.",
    ...
    },
    {
        ...
        logros: [
            { descripcion: "Estructuración de equipo y estrategia comercial" },
            { descripcion: "Posicionamiento y cierre de negocios importantes en el sector, que fueron relevantes para la empresa" }
        ]
    },
    {
        ...
        responsabilidades: [
            ...
            { descripcion: "Encargado en ausencia del Gerente Comercial de la coordinación del grupo comercial y de preventa en la asignación de proyectos y apoyo operativo y comercial" }
        ],
        logros: [
            { descripcion: "Estructuración de estrategia comercial para posicionar a la empresa en sectores donde no tenía presencia" },
            { descripcion: "Posicionamiento en el sector gobierno y cierre de negocios importantes para el crecimiento de la empresa" }
        ]
    },
    {
        ...
        logros: [
            { descripcion: "Posicionamiento en cuentas grandes del sector gobierno" },
            { descripcion: "Cierre de negocios importantes para la empresa en entidades como el Ministerio de Educación y la Secretaria de Educación del Distrito entre otros" }
        ]
    }
];
